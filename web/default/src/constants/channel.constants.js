export const CHANNEL_OPTIONS = [
  ...
  },
  {
    ...
    color: 'blue',
    description:
      'Async standalone video generation channel. Configure Base URL and add models manually.',
    tip: 'Video Task (V1) uses async task creation and polling. Model discovery is disabled in V1, so please enter supported model ids manually.',
  },
