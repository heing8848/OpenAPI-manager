...
func SetRelayRouter(router *gin.Engine) {
	...
	relayVideoTaskRouter := router.Group("/v1")
	relayVideoTaskRouter.Use(middleware.RelayPanicRecover(), middleware.TokenAuth())
	{
		relayVideoTaskRouter.POST("/videos/generations", controller.Relay)
		relayVideoTaskRouter.GET("/videos/generations/tasks", controller.Relay)
	}
}
