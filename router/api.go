...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		channelRoute.Use(middleware.AdminAuth())
		{
			...
			channelRoute.POST("/models/discover", controller.DiscoverChannelModels)
			channelRoute.POST("/:id/key/:keyId/enable_v2", controller.EnableChannelKeyV2)
			channelRoute.GET("/:id", controller.GetChannel)
			channelRoute.GET("/test", controller.TestChannels)
			channelRoute.GET("/test/:id", controller.TestChannel)
			channelRoute.GET("/update_balance", controller.UpdateAllChannelsBalance)
			channelRoute.GET("/update_balance/:id", controller.UpdateChannelBalance)
			channelRoute.POST("/reorder", controller.MoveChannelOrderV2)
		...
		workerRoute := apiRouter.Group("/worker")
		{
			workerRoute.POST("/route", middleware.TokenAuth(), controller.WorkerRoute)
			workerRoute.POST("/callback", middleware.AdminAuth(), controller.WorkerCallback)
			workerRoute.POST("/prepare_v2", middleware.TokenAuth(), controller.WorkerPrepareV2)
			workerRoute.POST("/callback_v2", middleware.AdminAuth(), controller.WorkerCallbackV2)
		}
	}
}
