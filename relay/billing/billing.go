...
func PostConsumeQuota(ctx context.Context, tokenId int, quotaDelta int64, totalQuota int64, userId int, channelId int, channelKeyId int, channelKeyIndex int, modelRatio float64, groupRatio float64, modelName string, tokenName string) {
