...
type Log struct {
	...
	ChannelKeyIndex   int    `json:"channel_key_index" gorm:"index"`
...
func RecordLog(ctx context.Context, userId int, logType int, content string) {
	RecordLogWithChannel(ctx, userId, logType, content, 0, 0)
}

func RecordLogWithChannel(ctx context.Context, userId int, logType int, content string, channelId int, channelKeyId int) {
